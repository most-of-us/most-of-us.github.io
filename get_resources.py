...
with open('./resources.csv', newline='') as csvfile:
	...
	for row in resourceReader:
		...
		if counter > 0:
			...
			DIVS += '''<div id="{postDate}_collapse" class="collapse"><iframe width="560" height="315" src="https://www.youtube.com/embed/{identifier}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>\n'''.format(postDate=postDate, description=description, identifier=identifier)
